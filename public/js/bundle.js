      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            _context.t0 = _context.t0.response.data ? _context.t0.response.data.message : _context.t0.message;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            _context2.t0 = _context2.t0.response.data ? _context2.t0.response.data.message : _context2.t0.message;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmlraXpheCIsImEiOiJjazh4YWhyeTAwNDZkM2dtdnh4NWR0c3ZmIn0.CQO00LQOaoGPAMx-qHDTaw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/vikizax/ck8xapjvh0t0o1ip9d3w4krql' //   center: [-118.113491, 34.111745],
    //   zoom: 10,
    //   interactive: false
...
/* eslint-disable */
var stripe = Stripe('pk_test_6nF5E1zan48H3PgMMzAMVcZB00uS595mQY');
